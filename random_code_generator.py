...
def _assign_statement(known_vars):
    ...
    if not known_vars or choice < 0.33:
        ...
        op = random.choice(["+", "-", "*", "/"])
        val = random.randint(1, 5)  # Avoid 0 for division
...
def _generate_code_block(known_vars, nesting_level, max_nesting=2, max_statements=2):
    """
...
if __name__ == "__main__":
    # This block is for testing the generator directly
